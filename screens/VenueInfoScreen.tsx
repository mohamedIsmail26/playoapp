  ...
  const VenueInfoScreen = () => {
    ...
    return (
      <SafeAreaView className="flex-1 bg-white pt-10">
        <ScrollView>
          ...
          <View className="p-4">
            ...
            <View className="flex-row items-center mt-2 space-x-2">
              ...
              <Text className="text-base font-medium">{route.params.timings}</Text>
            </View>

            {/* Location */}
            <View className="flex-row items-center mt-2 space-x-2">
              <Ionicons name="location-outline" size={22} color="black" />
              <Text className="text-sm font-medium w-[80%]">{route.params.location}</Text>
            </View>
          </View>

          {/* Ratings & Activities Section */}
          ...
          {/* Sports Available */}
          <Text className="text-base font-semibold mx-4 mt-4">Sports Available</Text>
        ...
        >
          <Text className="text-center text-white font-bold text-base">Book Now</Text>
        </Pressable>
      </SafeAreaView>
    );
  };

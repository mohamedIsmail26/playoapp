...
const GameSelectionScreen = () => {
  ...
  const { setSports, sports: selectedSports, firstName, lastName, image,sessionId } = useUserOnboarding();
  const { user } = useUser();
  ...
  return (
    <View className="flex-1 bg-white px-6 pt-4" style={{ paddingTop: insets.top + 12 }}>
      <Text className="text-2xl font-bold text-black mb-2">Pick Your Game</Text>
      <Text className="text-base text-gray-500 mb-6">Select your favorite sports to get started</Text>

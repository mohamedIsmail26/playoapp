import { View, Text, Image, ScrollView, Pressable, SafeAreaView, TouchableOpacity } from "react-native";
      ...
      <ScrollView className="flex-1 bg-gray-50">
        ...
        <View className="bg-white mx-4 mt-4 rounded-2xl shadow p-4">
          ...
          <View className="flex-row justify-between mt-4">
            ...
            <View className="items-center">
              <Text className="text-xl font-bold">{user?.playpals?.length || 0}</Text>
        ...
        <View className="bg-white mx-4 mt-4 rounded-2xl shadow p-4">
          ...
          <View className="flex-row flex-wrap justify-between">
            <View className="bg-gray-50 p-3 rounded-lg shadow-sm mb-4 w-[48%] items-center">
              ...
              <Text className="text-center font-medium text-gray-800">Punctual (46)</Text>
            </View>
            <View className="bg-gray-50 p-3 rounded-lg shadow-sm mb-4 w-[48%] items-center">
              <View className="bg-blue-100 p-4 rounded-full mb-2">
                <Text className="text-blue-600 text-xl">👥</Text>
              </View>
              <Text className="text-center font-medium text-gray-800">Team Player (47)</Text>
            </View>
          </View>
        </View>
        ...
        <View className="bg-gradient-to-r from-blue-50 to-white mx-4 mt-4 rounded-2xl shadow p-4">
          <View className="flex-row justify-between mb-4">
            <Text className="font-semibold text-base text-gray-800">Leaderboard</Text>
        ...
        <View className="bg-white mx-4 mt-4 rounded-2xl shadow p-4 mb-8">
          ...
          <TouchableOpacity className="mt-3 bg-green-600 py-2 rounded-lg">
            <Text className="text-white text-center font-semibold">Check Updates</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>

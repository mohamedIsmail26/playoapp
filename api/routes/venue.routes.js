...
// POST route to add multiple venues from the frontend
router.post('/add', async (req, res) => {
  try {
    const venues = req.body; // Expecting an array of venues from the frontend
...
// GET route to fetch all venues (optional, for testing)
